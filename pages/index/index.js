...
Page({
    ...
    getSum() {
        let sum = this.data.radio_1_1 +
            ...
            this.data.radio_4_8 +
            this.data.radio_4_9 +
            this.data.radio_4_10 +
            this.data.radio_4_11 +
            this.data.radio_4_12 +
            this.data.radio_4_13 +
            this.data.radio_4_14 +
            this.data.radio_4_15 +
            this.data.radio_4_16 +
            this.data.radio_5_1 +
            this.data.radio_5_2 +
            this.data.radio_5_3 +
            this.data.radio_5_4 +
            ...
            this.data.radio_9_4 +
            this.data.radio_9_5 +
            this.data.radio_10_1 +
            this.data.radio_10_2 +
            this.data.radio_10_3 +
            this.data.radio_10_4 +
            this.data.radio_10_5 +
            this.data.radio_11_1 +
            this.data.radio_11_2 +
            this.data.radio_11_3 +
            this.data.radio_12_1 +
            this.data.radio_12_2 +
            this.data.radio_12_3 +
            this.data.radio_12_4 +
            this.data.radio_12_5;
    ...
    overSub() {
        wx.navigateTo({url: '/pages/result/result?score=' + this.date.sumScore});
    }
})
